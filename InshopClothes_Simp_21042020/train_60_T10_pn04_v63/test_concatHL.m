...
param.test_net_file = fullfile(mainDir, modelDir, 'test_concatHL_d128.prototxt');
blob_name = 'pool5/7x7_s1';
record_file = 'Recall_concatHL_d128.txt';
%
param.save_start = 26000;
param.save_interval = 2000;
param.train_maxiter = 26000;
%%%%%%%%%%%Configurations End%%%%%%%
