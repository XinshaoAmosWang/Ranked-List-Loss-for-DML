function [batch_data, batch_label] = get_train_minibatch_ori_aug_v05 ( id_num, image_per_id, ...
                                        batch_data, batch_label, ...
                                        class_ids,  TrainImagePathBoxCell, ...
                                        force_square_size, input_size,...
                                        cropped_scale, aspect_ratio, ...
                                        flip_prob, ...
                                        ids, select_id_indexes )
    % sample severals ids
    ...
    for i = 1 : id_num
        ...
        for img = 1 : image_per_id
            ...
            batch_data(:,:,:, (i-1)*image_per_id + img ) = ...
                process_ori_image_aug_v04_21042020(sampled_images_of_this_id{img,1}, ...
                    force_square_size, input_size, ...
                    cropped_scale, aspect_ratio, ...
                    flip_prob, true);
        end
