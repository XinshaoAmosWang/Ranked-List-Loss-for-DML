function [batch_data, batch_label] = get_train_minibatch_ori_aug_v04 ( id_num, image_per_id, ...
    ...
    for i = 1 : id_num
        ...
        for img = 1 : image_per_id
            ...
            batch_data(:,:,:, (i-1)*image_per_id + img ) = process_ori_image_aug_v03(sampled_images_of_this_id{img,1}, ...
                                                                                    crop_padding, force_square_size, cropped_size, ...
                                                                                    true);
        end
