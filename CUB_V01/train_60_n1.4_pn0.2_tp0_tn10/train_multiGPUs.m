...
load('CUB_200_2011_TrainImagePathBoxCell.mat')
TrainImagePathBoxCell = CUB_200_2011_TrainImagePathBoxCell;
clear CUB_200_2011_TrainImagePathBoxCell;
...
param.gpu_id = [1];
modelDir = '60_n1.4_pn0.2_tp0_tn10';
...
trial_index = 1;
    ...
    while iter < param.train_maxiter
        ...
        [batch_data, batch_label] = get_train_minibatch_ori_aug_v04 ( id_num, image_per_id, ...
