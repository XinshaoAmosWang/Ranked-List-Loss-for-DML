function [batch_data, batch_label] = get_train_minibatch ( id_num, image_per_id, ...
                                        batch_data, batch_label, batch_size, ...
                                        class_ids,  TrainImageDataCell)
    % sample severals ids
    ...
    for i = 1 : id_num
        ...
        images_of_this_id = TrainImageDataCell(indexes);
        %
        ...
        for img = 1 : image_per_id
            ...
            batch_data(:,:,:, (i-1)*image_per_id + img ) = sampled_images_of_this_id{img};
        end
