function [images_feature] = forward_path_box_center_crop_v01(net, TestImagePathBoxCell, batch_size)
%forward_images_data 
...
for bt = 1 : num_batch
    ...
    for ind = 1 : batch_size
        ...
        batch_data(:,:,:, ind) = process_box_image_aug_v01(TestImagePathBoxCell{ind_img, 1}, ...
...
if  mod(num_img, batch_size) ~= 0
    ...
    for ind = 1 : num_img_remained
        batch_data(:,:,:, ind) = process_box_image_aug_v01(remained_images{ind, 1}, ...
